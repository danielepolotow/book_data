...
output_columns = ['User_id', 'profileName', 'number_of_reviews', 'Title', 'summary', 'text', 'sentiment_class']
final_relevant_reviews = final_relevant_reviews[output_columns]

if not final_relevant_reviews.empty:
    final_relevant_reviews.to_csv('relevant_user_reviews.csv', index=False)
